...
function info_setup() {
	...
	register_nav_menus(
		array(
			...
			'menu-left'    => esc_html__( 'Menu Left', 'info' ),
			'menu-right'    => esc_html__( 'Menu Right', 'info' ),
		)
	);
...
function info_scripts() {
	wp_enqueue_style( 'info-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'info-style', 'rtl', 'replace' );
	...
	wp_enqueue_script( 'info-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
